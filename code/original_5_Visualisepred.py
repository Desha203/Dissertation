'''
The purpose of this script is to visualise the predictions of multiple models on a randomly selected patient from the validation dataset.
    ...
    if not os.path.exists(patient_path):
        ...
        if os.path.exists(sample_npy_path):
            ...
            if num_models == 0:
                ...
                for n_slice in slices_to_visualize:
